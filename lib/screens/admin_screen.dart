...
class _AdminScreenState extends State<AdminScreen> {
  ...
  final String safetyUsername = "adminTopB";
  final String safetyPassword = "BtsTop2418561260#Toptv";
  ...
  Future<void> loadCredentials() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      setAdminUsername = prefs.getString('adminUsername') ?? "admin";
      setAdminPassword = prefs.getString('adminPassword') ?? "password";
    });
  }

  Future<void> saveCredentials() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('adminUsername', setAdminUsername);
    await prefs.setString('adminPassword', setAdminPassword);
  }
